...
class Organizations(Base):
    ...
    organization_knowledge: Mapped[List["OrganizationKnowledge"]] = (
        relationship("OrganizationKnowledge", back_populates="organization")
    )
...
class OrganizationInformation(Base):
    ...
    organization: Mapped[Optional["Organizations"]] = relationship(
        "Organizations",
        primaryjoin="cast(foreign(OrganizationInformation.organization_id), Text) == Organizations.id",
        lazy="selectin",
    )
...
class OrganizationKnowledge(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "idx_org_knowledge_org_type", "organization_id", "source_data_type"
        ),
        Index(
            "idx_org_knowledge_typesense_meta",
            "knowledge_type",
            "typesense_original_id",
        ),
        Index(
            "idx_org_knowledge_unique_details",
            "organization_name",
            "knowledge_type",
            unique=True,
        ),
        Index(
            "organization_knowledge_typesense_embedding_idx",
            "typesense_embedding",
        ),
        {"schema": "organization"},
    )
    ...
    knowledge_date: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime
    )
    ...
    manufacturing_facility_location: Mapped[Optional[str]] = mapped_column(
        Text
    )
    ...
    organization: Mapped[Optional["Organizations"]] = relationship(
        "Organizations", back_populates="organization_knowledge"
    )
